...
export const assets = {
  ...
  tokens: Object.fromEntries(['health_4','health_5','health_6','yellow_dice','orange_dice','red_dice','broken_yellow_dice','broken_orange_dice','broken_red_dice','shield_dice','yellow_destruction','orange_destruction','red_destruction'].map(key=>[key,new URL('assets/tokens/'+key+'.png',base).href])),
