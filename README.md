...
- 在浏览器本地完成视线计算
- 支持 50%～1000% 的画布缩放
- 干员选择支持本地对局历史、可取消的自动社区提交、云端撤回、公开对局、干员与地图统计；详见 [对局数据说明](operator-selection/privacy.html)。
...
测试前先安装依赖（`npm install --ignore-scripts`）。社区服务部署见 [cloud/README.md](cloud/README.md)。
...
本项目在 **NostalgicLegend** 的工作基础上开发与完善，感谢其所做的贡献。
