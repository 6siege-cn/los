...
const data={schemaVersion:2,revision:1,generatedAt:'2026-09-18T10:00:00Z',checkedAt:'2026-09-18T10:00:00Z',catalog,buckets:[{key:['bank','standard','炸弹模式','normal',false,false],total:9,attackWins:3,operators:{a:[9,3,0],b:[3,2,2]}},{key:['bank','standard','炸弹模式','normal',true,false],total:1,attackWins:1,operators:{'alt-a':[1,1,0]}}]};
